...
#eval ((List.range 12).any (fun t => centerColumn t)) && ((List.range 12).any (fun t => ! centerColumn t))
...
#eval ([(0, 1), (0, 2), (0, 3), (1, 1), (1, 2), (1, 3), (2, 1), (2, 2), (3, 1)] : List (ℕ × ℕ)).all (fun km => decide (evolve (km.2 * 2 ^ km.1 + km.1) ((km.2 * 2 ^ km.1 : ℕ) : ℤ) = centerColumn km.1))
