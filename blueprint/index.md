...
109 theorems on the board: 103 proved, 5 open, 1 claimed, 0 blocked, 0 abandoned. 0 of 109 without an object.
...
**Cited by.** nothing yet
**Status.** claimed, size S, under the wall centerColumn_other_isEventuallyPeriodic_of_center
...
**What this says.** The onset wall reduces to a preperiod bound for a finite map.
**Hypotheses.** (seeded statement; not yet checked)
...
**Cited by.** nothing yet
**Status.** open, size M, under the wall leftDiagonal_onset_le
