...
107 theorems on the board: 102 proved, 4 open, 1 claimed, 0 blocked, 0 abandoned. 0 of 107 without an object.
...
**What this says.** The centre column reads a run boundary at the origin.
**Hypotheses.** (seeded statement; not yet checked)
- `(t : ℕ)`
