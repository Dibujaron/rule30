...
127 theorems on the board: 123 proved, 4 open, 0 claimed, 0 blocked, 0 abandoned. 0 of 127 without an object.
...
**Cited by.** leftDiagonal_onset_le_iff_rowNat_return, leftDiagonal_onset_le_of_le_5000, leftDiagonal_onset_le_of_stepMod_preperiod, leftDiagonal_periodicFrom_of_rowNat_agree, rowNat_testBit_zero
...
**Cited by.** column_settledConfig_eq, leftDiagonal_onset_le_iff_rowNat_return, leftDiagonal_onset_le_of_black_ladder, leftDiagonal_onset_le_of_line, leftDiagonal_period_le_of_white_count, leftDiagonal_periodicFrom_pow, leftDiagonal_transient_front_law_pow, minimalPeriod_dvd, rightDiagonal_periodicFrom_pow
**Status.** proved, size S
...
**Cited by.** leftDiagonal_periodicFrom_of_rowNat_agree
**Status.** proved, size S, under the wall leftDiagonal_onset_le
...
**Cited by.** leftDiagonal_onset_le_iff_stepMod_return, leftDiagonal_onset_le_of_le_5000, leftDiagonal_onset_le_of_stepMod_preperiod, rowNat_agree_forward
**Status.** proved, size M, under the wall leftDiagonal_onset_le
