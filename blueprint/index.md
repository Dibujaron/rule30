...
92 theorems on the board: 87 proved, 4 open, 1 claimed, 0 blocked, 0 abandoned. 0 of 92 without an object.
...
**Cited by.** evolve_left_diagonals_isEventuallyPeriodic, evolve_left_second_diagonal, evolve_left_third_diagonal, leftDiagonal_onset_le_of_line, leftDiagonal_pair_never_eventually_shifted, leftDiagonal_periodicFrom_pow, not_evolve_period_adjacent
**Status.** proved, size M
...
**What this says.** The even-driver mirror: the period stays at `L` rather than doubling.
**Hypotheses.** (seeded statement; not yet checked)
- `(k L : ℕ)`
- `(hL0 : PeriodicFrom (rightDiagonal k) L 0)`
- `(hL1 : PeriodicFrom (rightDiagonal (k + 1)) L 0)`
