...
Topic: rightDiagonal minimal periods: are they unbounded? Sextant's abstract route stalled because the system admits flat towers (constants identically 1), a degenerate bounded-period solution it could not exclude — and rightDiagonal_not_constant, proved 2026-09-08, excludes exactly that for the real object. Restart the abstract argument with that case ruled out rather than working around it, and say plainly whether non-constant is enough or what else the argument still needs.

Attack document: c:/Users/dibuj/dev/rule30/docs/attacks/2026-09-08-rightdiagonal-minimal-periods-are-they-unbounded-sextant-s-abstract-route-stalled-because-the-system-admits-flat-towers.md
...
87 theorems on the board: 83 proved, 4 open, 0 claimed, 0 blocked, 0 abandoned. 0 of 87 without an object.
...
**Cited by.** config_eq_of_right_and_column
**Status.** proved, size M
...
**Cited by.** column_settledConfig_eq, evolve_left_edge, evolve_left_second_diagonal, evolve_right_edge, evolve_right_second_diagonal, not_evolve_period_adjacent
**Status.** proved, size M
...
**Cited by.** evolve_left_diagonals_isEventuallyPeriodic, evolve_left_second_diagonal, evolve_left_third_diagonal, leftDiagonal_pair_never_eventually_shifted, leftDiagonal_periodicFrom_pow, not_evolve_period_adjacent
**Status.** proved, size M
...
**Cited by.** evolve_left_diagonals_isEventuallyPeriodic, evolve_left_fourth_diagonal, evolve_left_third_diagonal, leftDiagonal_pair_never_eventually_shifted, leftDiagonal_periodicFrom_pow
**Status.** proved, size M
...
**Cited by.** leftDiagonal_step_onset_dichotomy, leftDiagonal_step_period_dichotomy
...
- `(t : ℕ)`
**Conclusion.** `evolve t (t : ℤ) = true`
**Cited by.** evolve_right_second_diagonal, rightDiagonal_not_constant, rightDiagonal_periodicFrom_pow
**Status.** proved, size M
...
**Cited by.** rightDiagonal_antiperiodic_of_odd_driver, rightDiagonal_not_constant, rightDiagonal_periodicFrom_step
**Status.** proved, size S
...
**Cited by.** column_settledConfig_eq, leftDiagonal_periodicFrom_pow, leftDiagonal_transient_front_law_pow, rightDiagonal_periodicFrom_pow
**Status.** proved, size S
