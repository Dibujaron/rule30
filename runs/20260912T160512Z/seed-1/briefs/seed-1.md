...
The closed table further down is the whole record of what has closed in P1, 149 closed as it
...
## This tier is for P1
This seeding pass is aimed at one region of the board, P1: the aperiodicity conjecture — the centre column of Rule 30 never becomes periodic, however far out you look and however long you wait for the repetition to start.
Only P1 nodes are listed below, open and closed. A proposal outside P1 will not be landed, however true or cheap it is.

## What is open in P1
Every P1 node on the board nobody has closed, 4 open.
...
## What has closed in P1, and what it cost
...
cheap, which is what you are choosing between.
  ...
  centerColumn_not_eventually_constant  size=L  opus  $2.13
  column_neg_one_damage_mask  size=M  sonnet  $0.76
  column_neg_two_damage_derivative  size=M  sonnet  $1.73
  column_damage_zero_of_black_run  size=M  sonnet  $1.39
  centerColumn_periodic_damage_white  size=L  opus  $1.85
  centerColumn_eq_evolve_mul_pow  size=M  sonnet  $1.06
  column_one_succ_of_white  size=S  haiku  $0.86
  centerColumn_periodic_neg_one_black_times  size=M  sonnet  $0.62
  centerColumn_not_isEventuallyPeriodic_of_white_times  size=M  sonnet  $1.73
  col_one_of_white  size=S  haiku  $0.63
  white_run_monotone  size=S  haiku  $0.34
  centre_forced_after_double_white  size=M  sonnet  $1.17
  white_run_forbidden  size=S  haiku  $0.40
  rowStep_prefix_minimal  size=S  haiku  $0.46
  rowStep_agree_succ_two_of_triple  size=M  sonnet  $0.71
  rowStep_forced_advance_at_most_two  size=S  haiku  $0.35
  rule30_alternating_step  size=M  sonnet  $1.42
  column_alternating_of_black_run  size=M  sonnet  $1.44
  centerColumn_not_isEventuallyPeriodic_of_long_black_runs  size=M  sonnet  $1.11
  column_black_run_of_alternating  size=M  sonnet  $1.27
  column_alternating_shrink  size=M  sonnet  $2.07
  centerColumn_not_isEventuallyPeriodic_of_deep_alternating  size=M  sonnet  $1.16
  centerColumn_white_run_le_period  size=S  haiku  $1.03
...
`docs/connections/2026-09-10-the-switch-index-sequence-over-a-finite-alphabet-does-obstruction-9-s-residual-become-tractable-when-it-is-read-as-a-seq.md`
...
`docs/connections/2026-09-11-crystal-72-literature-clause-the-one-slot-in-the-p1-fence-still-open-the-board-proves-four-sufficient-conditions-for-p1.md`
...
`docs/connections/2026-09-11-make-p3-sayable-p3-is-wolfram-computational-irreducibility-conjecture-for-rule-30-centre-column-and-docs-prize-md-states.md`
...
`docs/connections/2026-09-12-effective-and-algorithmic-randomness-of-individual-orbits-aimed-at-p1-s-run-shaped-residual-this-vantage-is-chorobates-s.md`
...
`docs/connections/2026-09-12-the-subshift-of-the-centre-column-itself-the-orbit-closure-x-c-of-c-under-the-shift-and-whether-it-carries-an-invariant.md`
...
`docs/connections/2026-09-12-the-theory-of-automatic-sequences-attacked-at-one-bounded-statement-the-rule-30-centre-column-is-not-2-automatic-this-is.md`
...
`docs/connections/2026-09-12-walnut-and-the-decidability-of-first-order-statements-about-automatic-sequences-aimed-not-at-the-centre-column-but-at-th.md`
...
**UNFINISHED — this attack's surviving-claims section was never written.**
