...
Topic: centerColumn_other_isEventuallyPeriodic_of_center: the centre column of the settled configuration

Attack document: c:/Users/dibuj/dev/rule30/docs/attacks/2026-09-07-centercolumn-other-iseventuallyperiodic-of-center-the-centre-column-of-the-settled-configuration.md
...
73 theorems on the board: 67 proved, 6 open, 0 claimed, 0 blocked, 0 abandoned. 0 of 73 without an object.
...
**What this says.** No two pairs of adjacent left diagonals ever eventually agree.
**Hypotheses.** (seeded statement; not yet checked)
- `(k d N : ℕ)`
- `(hd : 0 < d)`
...
**What this says.** The eventual periods of the left diagonals are unbounded
**Hypotheses.** (seeded statement; not yet checked)
- `(a : ℕ)`
**Conclusion.** `∃ k, ∀ N, ¬ PeriodicFrom (leftDiagonal k) (2 ^ a) N`
**Cited by.** nothing yet
**Status.** open, size L
