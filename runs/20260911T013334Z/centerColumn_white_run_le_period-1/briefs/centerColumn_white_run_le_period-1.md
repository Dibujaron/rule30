...
- The harness verifies with a generated check theorem — `theorem harness_check : type_of% Statements.centerColumn_white_run_le_period := centerColumn_white_run_le_period` — against the captain's statement. So your theorem must be named exactly `centerColumn_white_run_le_period` and have exactly the stated type. A weakened or generalized restatement fails, even one you could prove.
