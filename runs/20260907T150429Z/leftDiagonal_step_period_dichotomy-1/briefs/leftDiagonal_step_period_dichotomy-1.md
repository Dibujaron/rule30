...
- The harness verifies with a generated check theorem — `theorem harness_check : type_of% Statements.leftDiagonal_step_period_dichotomy := leftDiagonal_step_period_dichotomy` — against the captain's statement. So your theorem must be named exactly `leftDiagonal_step_period_dichotomy` and have exactly the stated type. A weakened or generalized restatement fails, even one you could prove.
