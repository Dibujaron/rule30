...
- The harness verifies with a generated check theorem — `theorem harness_check : type_of% Statements.stepMod_preperiod_le_of_le_11 := stepMod_preperiod_le_of_le_11` — against the captain's statement. So your theorem must be named exactly `stepMod_preperiod_le_of_le_11` and have exactly the stated type. A weakened or generalized restatement fails, even one you could prove.
