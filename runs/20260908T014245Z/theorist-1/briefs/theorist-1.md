...
Topic: centerColumn_other_isEventuallyPeriodic_of_center: first read settledCenter to a billion terms with the bit-parallel orbit, then the wall through the half-line tier and the black-time identity now that the settled row is on the board

Attack document: c:/Users/dibuj/dev/rule30/docs/attacks/2026-09-08-centercolumn-other-iseventuallyperiodic-of-center-first-read-settledcenter-to-a-billion-terms-with-the-bit-parallel-orbit-then-the-wall-through-the-half-line-tier-and-the-black-time-identity-now-that-the-settled-row-is-on-the-board.md
...
75 theorems on the board: 71 proved, 4 open, 0 claimed, 0 blocked, 0 abandoned. 0 of 75 without an object.
...
**Cited by.** leftDiagonal_period_unbounded
**Status.** proved, size M
...
**Cited by.** leftDiagonal_pair_never_eventually_shifted, leftDiagonal_periodicFrom_step_of_black
