...
The closed table further down is the whole record of what has closed in P1, 105 closed as it
...
### leftDiagonal_onset_le  size=L  deps=(none)
...
DOES NOT PROVE: This is not a prize conjecture and does not bear on one. It is a claim about the left edge of the cone, where periodicity is proved; the centre column never enters the region this statement describes, since at time t it sits on diagonal t, whose onset has not been reached. Nobody knows how to prove it. Never dispatch as an ordinary leaf; never weaken it. A proposal to attack it is a proposal for lemmas that would imply it.
