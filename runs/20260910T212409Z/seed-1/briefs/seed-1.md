...
The closed table further down is the whole record of what has closed, 138 closed as it
...
## What is open
Every node on the board nobody has closed, 10 open.
...
cheap, which is what you are choosing between.
  ...
  evolve_eq_false_of_outside_cone  size=M  sonnet  $0.80
  evolve_left_edge  size=M  sonnet  $0.37
  evolve_right_edge  size=M  sonnet  $0.18
  evolve_left_second_diagonal  size=M  sonnet  $0.18
  evolve_left_third_diagonal  size=M  sonnet  $0.32
  ...
  evolve_left_diagonal_recurrence  size=S  haiku  $0.16
  evolve_left_fourth_diagonal  size=M  sonnet  $0.49
  evolve_left_fifth_diagonal  size=M  sonnet  $0.27
  evolve_right_second_diagonal  size=M  sonnet  $0.36
  evolve_left_fourth_diagonal_isEventuallyPeriodic  size=S  haiku  $0.17
  evolve_left_diagonals_isEventuallyPeriodic  size=M  sonnet  $0.47
  bool_map_iterate_three  size=S  sonnet  $0.59
  isEventuallyPeriodic_shift  size=S  haiku  $0.21
  isEventuallyPeriodic_common_period  size=M  sonnet  $0.24
  bool_driven_eventually_two_periodic  size=M  sonnet  $0.64
  evolve_left_diagonal_isEventuallyPeriodic_step  size=M  sonnet  $0.66
  evolve_sub_one_eq_xor  size=S  haiku  $0.20
  evolve_period_sub_one  size=S  haiku  $0.32
  evolve_period_sub  size=M  sonnet  $0.42
  not_evolve_period_adjacent  size=M  sonnet  $0.45
  not_isEventuallyPeriodic_adjacent  size=S  haiku  $0.20
  centerColumn_right_not_both_isEventuallyPeriodic  size=S  haiku  $0.15
  centerColumn_not_eventually_periodic_of_right  size=S  haiku  $0.12
  isEventuallyPeriodic_of_periodic_step  size=M  sonnet  $0.47
  strip_succ  size=M  sonnet  $0.51
  strip_eventuallyPeriodic  size=S  haiku  $0.15
  evolve_isEventuallyPeriodic_of_between  size=S  haiku  $0.16
  not_isEventuallyPeriodic_pair  size=M  sonnet  $0.39
  isEventuallyPeriodic_column_unique  size=S  haiku  $0.14
  centerColumn_not_eventually_periodic_of_any_other  size=S  haiku  $0.14
  periodicFrom_mul  size=S  haiku  $0.25
  leftDiagonal_periodicFrom_step  size=M  sonnet  $0.65
  leftDiagonal_periodicFrom_pow  size=M  sonnet  $0.95
  rightDiagonal_recurrence  size=S  haiku  $0.35
  bool_xor_driven_periodicFrom  size=M  sonnet  $0.87
  rightDiagonal_periodicFrom_step  size=M  sonnet  $0.41
  rightDiagonal_periodicFrom_pow  size=M  sonnet  $0.57
  rightDiagonal_isEventuallyPeriodic  size=S  haiku  $0.25
  leftDiagonal_recurrence  size=S  haiku  $0.24
  bool_driven_periodicFrom_of_return  size=S  haiku  $0.30
  bool_driven_periodicFrom_of_reset  size=S  haiku  $0.34
  leftDiagonal_periodicFrom_step_of_black  size=M  sonnet  $0.74
  leftDiagonal_step_period_dichotomy  size=M  sonnet  $0.61
  rule30_ne_of_left_ne  size=S  haiku  $0.35
  rule30_left_local_law  size=S  sonnet  $0.81
  sideways_inverse  size=S  haiku  $0.21
  evolveFrom_eq_of_agree_on_window  size=M  sonnet  $0.51
  rule30_leftPermutive  size=S  haiku  $0.22
  evolveFrom_leftPermutive  size=M  sonnet  $1.40
  rightmost_difference_moves_right  size=M  sonnet  $0.65
  window_count_half  size=L  opus  $2.48
  rowCell_eq_evolve  size=L  opus  $2.31
  ...
  evolveHalfLeft_eq_column  size=M  sonnet  $0.73
  evolveHalfRight_eq_column  size=M  sonnet  $1.32
  leftSolve_eq_column  size=M  sonnet  $1.10
  column_succ_of_black  size=S  haiku  $0.56
  column_one_of_white  size=S  sonnet  $0.54
  config_eq_of_right_and_column  size=M  sonnet  $0.87
  centerColumn_succ_of_black  size=S  haiku  $0.22
  leftDiagonal_pair_never_eventually_shifted  size=M  sonnet  $0.77
  leftDiagonal_period_unbounded  size=L  opus  $1.74
  leftDiagonal_period_unbounded_le  size=L  opus  $2.10
  leftDiagonal_step_onset_dichotomy  size=M  sonnet  $0.52
  leftDiagonal_white_of_shift  size=S  haiku  $0.32
  leftDiagonal_shift_of_white  size=S  sonnet  $0.42
  leftDiagonal_black_after_white  size=S  haiku  $0.32
  leftDiagonal_compl_after_black  size=S  haiku  $0.26
  leftDiagonal_transient_front_law  size=S  haiku  $0.30
  leftDiagonal_transient_mask_law  size=S  haiku  $0.15
  leftDiagonal_transient_front_law_pow  size=S  haiku  $0.55
  leftDiagonal_mul_pow_eq_settledCenter  size=S  haiku  $0.54
  column_settledConfig_eq  size=L  fable  $2.69
  rightDiagonal_antiperiodic_of_odd_driver  size=M  opus  $1.42
  rightDiagonal_not_constant  size=M  opus  $1.35
  rightDiagonal_driver_flip_iff_white  size=S  sonnet  $0.64
  leftDiagonal_period_le_of_black_between  size=M  sonnet  $0.83
  leftDiagonal_eq_rowNat_testBit  size=S  haiku  $0.30
  leftDiagonal_onset_le_of_line  size=M  sonnet  $0.61
  rightDiagonal_periodicFrom_step_of_even_driver  size=M  sonnet  $0.92
  centerColumn_other_of_cohomologous_column  size=M  sonnet  $1.11
  rightDiagonal_period_unbounded  size=L  opus  $2.11
  rule30_translate  size=S  haiku  $0.37
  evolveFrom_translate  size=S  haiku  $0.34
  evolveFrom_evolve  size=S  haiku  $0.21
  rightDiagonal_first_failure  size=M  sonnet  $0.49
  minimalPeriod_dvd  size=M  sonnet  $0.72
  centerColumn_not_isEventuallyPeriodic_of_cohomologous  size=S  haiku  $0.49
  damage_not_autonomous  size=S  haiku  $0.32
  adjacent_difference_not_eventually_one  size=M  sonnet  $0.63
  exists_config_same_centerColumn  size=L  opus  $2.37
  leftDiagonal_onset_le_iff_rowNat_return  size=L  opus  $1.50
  leftDiagonal_agree_succ_iff  size=M  sonnet  $1.00
  rowNat_return_succ_iff  size=M  sonnet  $0.88
  rule30_run_boundary  size=S  haiku  $0.45
  centerColumn_run_boundary  size=S  sonnet  $0.81
  rowNat_mod_eq_iterate  size=M  sonnet  $0.96
  leftDiagonal_onset_le_of_stepMod_preperiod  size=M  sonnet  $0.90
  leftDiagonal_onset_le_iff_stepMod_return  size=M  sonnet  $0.90
  front_survival  size=S  haiku  $0.56
  front_survival_of_white  size=S  haiku  $0.23
  front_survival_of_agree  size=S  haiku  $0.47
  leftDiagonal_onset_le_of_le_5000  size=M  sonnet  $1.32
  stepMod_preperiod_le_of_le_11  size=M  sonnet  $0.62
  step_two_mul  size=S  haiku  $0.76
  stepMod_iterate_two_mul  size=M  sonnet  $1.09
  periodicFrom_trans_period  size=S  sonnet  $0.88
  centerColumn_eq_rowNat_testBit  size=S  haiku  $0.23
  leftDiagonal_not_both_eventually_white  size=S  sonnet  $1.36
  leftDiagonal_onset_le_of_black_ladder  size=M  sonnet  $1.30
  leftDiagonal_period_le_of_white_count  size=L  opus  $2.14
  leftDiagonal_step_of_white_parity  size=L  opus  $2.90
  rowNat_testBit_zero  size=S  haiku  $0.22
  rowNat_agree_forward  size=S  sonnet  $1.04
  leftDiagonal_periodicFrom_of_rowNat_agree  size=M  sonnet  $0.66
  leftDiagonal_onset_le_not_of_black_ladder  size=S  sonnet  $1.32
  stepMod_preperiod_of_return  size=S  sonnet  $0.69
  stepMod_preperiod_of_odd  size=M  sonnet  $1.09
  rowNat_return_succ_two  size=M  sonnet  $0.80
  leftDiagonal_periodicFrom_step_two_of_black  size=M  sonnet  $0.80
  leftDiagonal_periodicFrom_of_rowNat_agree_any  size=S  haiku  $1.02
  rowStep_agree_forward  size=S  sonnet  $0.99
  stepMod_iterate_eq_rowStep_mod  size=S  haiku  $0.59
  rowStep_agree_succ_iff  size=M  sonnet  $0.79
  rowStep_agree_succ_two_iff  size=M  sonnet  $1.20
  periodicFrom_gcd  size=M  sonnet  $1.12
  leftDiagonal_period_le_iff_rowNat_period  size=L  opus  $2.36
  centerColumnCount_block  size=S  haiku  $0.33
  centerColumnCount_eq_stepMod_count  size=M  sonnet  $0.53
  centerColumn_density_tendsto_half_iff_excess_nat  size=M  sonnet  $1.18
  centerColumn_density_tendsto_half_of_nearby_cuts  size=L  opus  $1.64
...
`docs/connections/2026-09-10-cryptanalysis-of-rule-30-as-a-stream-cipher-meier-and-staffelbach-1991-and-what-a-successful-attack-says-about-p1-astrol.md`

**UNFINISHED — this document's conclusions section was never written. The sections above it in the document may still be worth reading, but nothing here was handed on.**

### Sighting: `centerColumn_other_isEventuallyPeriodic_of_center` from the machine-model vantage
`docs/connections/2026-09-10-machine-models-for-computational-irreducibility-what-uniform-step-counted-cost-model-with-binary-input-encoding-would-ma.md`
