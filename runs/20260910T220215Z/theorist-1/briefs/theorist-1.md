...
155 theorems on the board: 150 proved, 4 open, 1 claimed, 0 blocked, 0 abandoned. 0 of 155 without an object.
...
**Cited by.** column_damage_zero_of_black_run, column_one_of_white, column_succ_of_black, leftSolve_eq_column
**Status.** proved, size S
...
**What this says.** Two white centre cells with a black neighbour force the third.
**Hypotheses.** (seeded statement; not yet checked)
- `(X : Config)`
- `(t : ℕ)`
...
**Cited by.** nothing yet
**Status.** claimed, size M, under the wall centerColumn_other_isEventuallyPeriodic_of_center
...
**Cited by.** centerColumn_succ_of_black, column_damage_zero_of_black_run
**Status.** proved, size S, under the wall centerColumn_other_isEventuallyPeriodic_of_center
...
**Cited by.** evolve_left_diagonals_isEventuallyPeriodic, evolve_left_second_diagonal, evolve_left_third_diagonal, leftDiagonal_not_both_eventually_white, leftDiagonal_onset_le_of_black_ladder, leftDiagonal_onset_le_of_line, leftDiagonal_pair_never_eventually_shifted, leftDiagonal_periodicFrom_pow, not_evolve_period_adjacent, rightDiagonal_period_unbounded, rowNat_testBit_zero
**Status.** proved, size M
...
**Cited by.** evolve_left_diagonals_isEventuallyPeriodic, evolve_left_fourth_diagonal, evolve_left_third_diagonal, leftDiagonal_not_both_eventually_white, leftDiagonal_onset_le_of_black_ladder, leftDiagonal_onset_le_of_line, leftDiagonal_pair_never_eventually_shifted, leftDiagonal_periodicFrom_pow
**Status.** proved, size M
