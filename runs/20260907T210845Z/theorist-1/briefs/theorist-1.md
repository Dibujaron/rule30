...
Topic: centerColumn_other_isEventuallyPeriodic_of_center: the masking mechanism in the transient band, why a diagonal settles before its drivers

Attack document: c:/Users/dibuj/dev/rule30/docs/attacks/2026-09-07-centercolumn-other-iseventuallyperiodic-of-center-the-masking-mechanism-in-the-transient-band-why-a-diagonal-settles-before-its-drivers.md
...
75 theorems on the board: 69 proved, 6 open, 0 claimed, 0 blocked, 0 abandoned. 0 of 75 without an object.

## Configuration

### column_settledConfig_eq

**What this says.** The settled picture is the rule 30 evolution of the settled row.
...
**Status.** open, size L, under the wall centerColumn_other_isEventuallyPeriodic_of_center
...
**What this says.** The settled centre column is well defined.
**Hypotheses.** (seeded statement; not yet checked)
- `(k m : ℕ)`
- `(hm : 1 ≤ m)`
**Conclusion.** `leftDiagonal k (m * 2 ^ k) = settledCenter k`
**Cited by.** nothing yet
**Status.** open, size S, under the wall centerColumn_other_isEventuallyPeriodic_of_center
