...
### Attempt 6 — fable, abandoned

Not proved and the wall stands; the file builds with a proved reduction of the node to a universal statement about the truncated row map started from ANY number below 2^(k+1), which the kernel confirms for every start at every width to 12 (and the survey to width 18, period never above 4), alongside the seed's own depth-5000 check.

### Attempt 7 — fable, rate_limited

the five-hour window is rate limiting; resume session 098252f3-9471-47b4-9307-eac66e192e02

### Attempt 8 — fable, rate_limited

the five-hour window is rate limiting; resume session 409271fc-8439-4fa0-8480-517281fa6596

### Attempt 9 — fable, rate_limited

the five-hour window is rate limiting; resume session 55492935-ce31-423f-b74c-acae4591639b

### Attempt 10 — fable, rate_limited

the five-hour window is rate limiting; resume session dcfa5972-f04d-438a-9e83-d40517ca6ad0

### Attempt 11 — fable, abandoned

Not proved and the wall stands; the file builds with the settled boundary defined as a computable walk on the packed rows, a proof that everything under the walk is settled, and the reduction of the wall to "the walk is frozen at most k times in its first 2k steps", kernel-checked to depth 100 and measured frozen on 25.15% of steps over 50,000 rows.
