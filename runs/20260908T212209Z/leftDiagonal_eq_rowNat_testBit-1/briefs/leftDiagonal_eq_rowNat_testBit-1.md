...
- The harness verifies with a generated check theorem — `theorem harness_check : type_of% Statements.leftDiagonal_eq_rowNat_testBit := leftDiagonal_eq_rowNat_testBit` — against the captain's statement. So your theorem must be named exactly `leftDiagonal_eq_rowNat_testBit` and have exactly the stated type. A weakened or generalized restatement fails, even one you could prove.
